...
**Agent Permissions:** ✅ Read-only (informational)
...
- ✅ Version managers lazy-loaded (nvm, pyenv)
...
|------|-------------|----------|-------------|
| `~/.zshrc` | ✅ Read/Write | Configuration, aliases | Yes (template) |
| `~/.zsh_local` | ❌ No Access | Secrets, personal settings | **NO** |
| `~/.p10k.zsh` | ✅ Read-only | Prompt configuration | Optional |
