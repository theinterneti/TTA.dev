...
class TestCommitValidation:
    ...
    @pytest.mark.asyncio
    async def test_commit_message_too_short_raises_error(self, git_primitive, workflow_context):
    ...
    @pytest.mark.asyncio
    async def test_commit_requires_conventional_format(self, git_primitive, workflow_context):
...
class TestEnforceHygiene:
    ...
    @pytest.mark.asyncio
    async def test_warning_mode_returns_warnings(self, agent_identity, tmp_path, workflow_context):
        ...
        result = await git_primitive.execute({"action": "enforce_frequency"}, workflow_context)
...
class TestWorkflowIntegration:
    ...
    @pytest.mark.asyncio
    async def test_commits_tracked_in_context(self, git_primitive, workflow_context, tmp_path):
    ...
    @pytest.mark.asyncio
    async def test_integration_tracked_in_context(self, git_primitive, workflow_context):
