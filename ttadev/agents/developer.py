...
from ttadev.primitives.llm import COMPLEXITY_COMPLEX, TASK_CODING, TaskProfile
...
DEVELOPER_SPEC = AgentSpec(
    ...
    default_task_profile=TaskProfile(task_type=TASK_CODING, complexity=COMPLEXITY_COMPLEX),
)
