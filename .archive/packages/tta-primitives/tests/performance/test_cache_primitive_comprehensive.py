...
class TestCacheHitMiss:
    ...
    async def test_cache_miss_on_first_access(self):
        ...
        cache = CachePrimitive(primitive=mock_primitive, cache_key_fn=lambda d, c: d["key"])
...
class TestCacheTTLExpiration:
    ...
    async def test_cache_return_before_ttl(self):
        ...
        cache = CachePrimitive(
            primitive=mock_primitive, cache_key_fn=lambda d, c: d["key"], ttl_seconds=ttl
        )
        context = WorkflowContext()
    ...
    async def test_longer_ttl_values(self, ttl_value):
        ...
        cache = CachePrimitive(
            primitive=mock_primitive, cache_key_fn=lambda d, c: d["key"], ttl_seconds=ttl_value
        )
        context = WorkflowContext()
        input_data = {"key": "test_key"}
...
class TestCacheEdgeCases:
    ...
    async def test_cache_key_function_various_types(self):
        ...
        cache = CachePrimitive(primitive=mock_primitive, cache_key_fn=lambda d, c: str(d["val"]))
        context = WorkflowContext()
    ...
    async def test_cache_none_input(self):
        ...
        cache = CachePrimitive(primitive=mock_primitive, cache_key_fn=lambda d, c: "none_key")
        context = WorkflowContext()
    ...
    async def test_cache_empty_dict_input(self):
        ...
        cache = CachePrimitive(primitive=mock_primitive, cache_key_fn=lambda d, c: "empty_dict_key")
        context = WorkflowContext()
    ...
    async def test_concurrent_access(self):
        ...
        cache = CachePrimitive(primitive=mock_primitive, cache_key_fn=lambda d, c: "concurrent_key")
        context = WorkflowContext()
