...
class CodebaseScanner:
    ...
    def __init__(self, root_dir: Path):
        ...
        self.non_actionable_dirs = ["docs", "examples"]
    ...
    def _scan_file(self, file_path: Path) -> list[CodeTODO]:
        ...
        try:
            ...
            for i, line in enumerate(lines):
                ...
                if match:
                    todo_text_raw = line.strip()
                    if "#non-actionable" in todo_text_raw.lower():
                        continue
    ...
    def _categorize_file(self, file_path: Path) -> str:
        ...
        if any(non_actionable_dir in path_str for non_actionable_dir in self.non_actionable_dirs):
            return "non-actionable"
        elif ".augment" in path_str:
            return "augment"
