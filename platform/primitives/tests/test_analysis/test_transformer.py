...
"""
        ...
        circuit_breaker_import = any("CircuitBreakerPrimitive" in imp for imp in imports)
...
"""
        ...
        model_routing = [p for p in detector.delegation_patterns if p["type"] == "model_routing"]
...
"""
        ...
        agent_dispatch = [p for p in detector.delegation_patterns if p["type"] == "agent_dispatch"]
...
"""
        ...
        assert (
            "success_count" in pattern["counter_vars"] or "failure_count" in pattern["counter_vars"]
        )
