---
name: git-commit
description: 'Use this skill when making git commits in the TTA.dev repository. Enforces Conventional Commits format and pre-commit quality checks. Invoke when the user says "commit", "git commit", "save changes", "commit my work", or asks how to commit code.'
---
