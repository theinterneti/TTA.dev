...
def main():
    ...
    print("\nResults:")
    print(
        f"Knowledge Resource server instantiation: {'SUCCESS' if knowledge_server_success else 'FAILURE'}"
    )
    print(
        f"Agent Tool server instantiation: {'SUCCESS' if agent_tool_server_success else 'FAILURE'}"
    )
