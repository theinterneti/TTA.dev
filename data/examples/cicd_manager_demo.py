...
async def main():
    ...
    with (
        patch("tta_agent_coordination.experts.github_expert.GitHubAPIWrapper") as MockGH,
        patch("tta_agent_coordination.experts.docker_expert.DockerSDKWrapper") as MockDocker,
        patch("tta_agent_coordination.experts.pytest_expert.PyTestCLIWrapper") as MockPyTest,
    ):
