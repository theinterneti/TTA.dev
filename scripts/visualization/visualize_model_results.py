...
This script visualizes and compares model test results from the model testing framework (scripts/model-testing/model_test.py).
...
def main():
    ...
    parser.add_argument(
        "--analysis",
        help="Path to analysis JSON file (if not provided, will use results_analysis.json)",
    )
    parser.add_argument(
        "--output-dir",
        help="Directory to save visualizations (default: charts subdirectory in results directory)",
    )
